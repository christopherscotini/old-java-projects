...
import br.com.portal.utils.constants.LocaleConstants;
...
public abstract class CpfCnpjUtils {
	...
	public static Long extraiCpfCnpjPrincipal(String sdocumento){
		...
		// remove a mascara
		documento = ProjetoUtils.replaceAll(documento,".", "");
		documento = ProjetoUtils.replaceAll(documento,"/", "");
		documento = ProjetoUtils.replaceAll(documento,"-", "");

		// Deve - se validar o tamanho da string pois, caso ela seje referente ao CNPJ seu tamanho ser� de 14, sabendo que a string que cont�m o CPF ter� 9 campos e a string que cont�m
		// o CNPJ cont�m 8 campos, devemos atribuir o numero zero ao inicio do CNPJ.
		...
		// pega somente as 9 primeiras posi�oes.
	 ...
	 * 
	 * N�o se aplica ao CPF. - Returna 0.
	 */
	 ...
	 * @return Ter� como retorno o n�mero principal do CPF/CNPJ.
	 * 
	...
	public static Long extrairCpfCnpjPrincipalLong(Long cpfCnpj){
		...
		//Sempre utilizamos como referencia o digito de controle e o n�mero filial que sempre existir�o, portanto o resto ser� sempre o corpo principal.
		String corpoPrincipal = valorFormatado.substring(0,valorFormatado.length() - 6);
		
		//Caso n�o exista corpo principal no CPF/CNPJ ent�o ser� passado 0 como retorno.
	 ...
	 * 
	 * @param cpfCnpj Este campo pode ser tanto um CPF quanto um CNPJ.
	 * @return Ter� como retorno o n�mero filial do CPF/CNPJ. Caso seja CPF este valor retornado ser� 0000.
	 *
	 * entrada: 131073898000073   - CPF vindo da base PIC 9(15)
	 * 			046189718000179   - CNPJ vindo da base PIC 9(15)
	 * 
	...
	public static Integer extrairCpfCnpjFilialInteiro(Long cpfCnpj){
		...
		//Sempre utilizamos como referencia o digito de controle e o n�mero filial que sempre existir�o, portanto o filial ser� o �ndice entre o final -6 e o final -2, onde final � o tamanho do campo.
	 ...
	 * 
	 * @param cpfCnpj Este campo pode ser tanto um CPF quanto um CNPJ.
	 * @return Ter� como retorno o d�gito de controle do CPF/CNPJ.
	 * 
	 *
	 * entrada: 131073898000073   - CPF vindo da base PIC 9(15)
	 * 			046189718000179   - CNPJ vindo da base PIC 9(15)
	...
	public static Integer extrairCpfCnpjDigitoControleInteiro(Long cpfCnpj){
		...
		//Sempre utilizamos como referencia o digito de controle e o n�mero filial que sempre existir�o, portanto o digito de controle ser� o �ndice entre o final -2 e o final, onde final � o tamanho do campo.
	...
	public static Long formatarCpfCnpjLong(String cpfCnpj){
		...
		//Caso ocorra uma barra na formata��o, ent�o poderemos tratar este campo como CNPJ
		if(cpfCnpjAux.indexOf('/') > -1){
			
			if(cpfCnpjAux.length() == 18){
				
			    cpfCnpjAux = ProjetoUtils.replaceAll(cpfCnpjAux,".","");
			    cpfCnpjAux = ProjetoUtils.replaceAll(cpfCnpjAux,"/","");
			    cpfCnpjAux = ProjetoUtils.replaceAll(cpfCnpjAux,"-","");
		...
		}//Caso N�O ocorra uma barra na formata��o, ent�o poderemos tratar este campo como CPF
		else{
